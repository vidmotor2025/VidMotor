...
def get_parser():
    ...
    parser.add_argument('--step', type=int, default=[160, 250], nargs='+',
        ...
        with torch.no_grad():
            for test_loader in self.data_loaders['test']:
                ...
                if epoch == self.arg.num_epoch - 1:
                    ...
                    writer.write_result(
                        dataset=test_loader.dataset.dataset_name, model_name='FR-Head', accuracy=final_accuracy * 100, f1=final_f1 * 100,
...
def import_class(name, base_module='SOTA.FR-Head'):
