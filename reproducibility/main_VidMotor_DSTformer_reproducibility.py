        ...
        with torch.no_grad():
            for test_loader in self.data_loaders['test']:
                ...
                if epoch == self.arg.num_epoch - 1:
                    ...
                    writer.write_result(
                        dataset=test_loader.dataset.dataset_name, model_name='VidMotor_DSTformer', accuracy=final_accuracy * 100, f1=final_f1 * 100, auc=final_auc * 100, balanced_acc=final_balanced_acc * 100)
                    row = (
