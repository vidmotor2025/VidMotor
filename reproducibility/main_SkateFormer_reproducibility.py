...
class Processor():
        ...
        with torch.no_grad():
            for test_loader in self.data_loaders['test']:
                ...
                if epoch == self.arg.num_epoch - 1:
                    ...
                    writer.write_result(
                        dataset=test_loader.dataset.dataset_name, model_name='SkateFormer', accuracy=final_accuracy * 100, f1=final_f1 * 100,
    ...
    def start(self):
        ...
        for test_dataset_config in arg.test_feeder_args:
            ...
            self.load_scheduler(len(self.data_loaders['train']))
