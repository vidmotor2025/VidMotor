    ...
    def adjust_learning_rate(self, epoch, idx, length_trainloader):
        ...
        if self.arg.optimizer == 'SGD' or self.arg.optimizer == 'Adam':
            if epoch < self.arg.warm_up_epoch:
                ...
                T_max = length_trainloader * (300 - self.arg.warm_up_epoch)
        ...
        with torch.no_grad():
            for test_loader in self.data_loaders['test']:
                ...
                if epoch == self.arg.num_epoch - 1:
                    ...
                    writer.write_result(
                        dataset=test_loader.dataset.dataset_name, model_name='HD-GCN', accuracy=final_accuracy * 100, f1=final_f1 * 100,
...
def import_class(name, base_module='SOTA.HD-GCN'):
