...
save_path = './results/reproduce_VidMotor_and_SOTA_results_runtime.xlsx'
...
for dataset in available_datasets:
    ...
    for model in model_list:
        ...
        if model == 'VidMotor':
            cmd = ('python reproducibility/main_VidMotor_ST-GCN_time_reproducibility.py '
        ...
        # Run MotionBERT experiments with specific pretrained model and config
            ...
            cmd = ('python reproducibility/main_%s_time_reproducibility.py '
