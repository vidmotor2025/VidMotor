...
def get_groups(dataset='Human36m', CoM=9):
    groups = []
    ...
    if dataset == 'NTU':
        ...
        if CoM == 8:
            groups.append([8])
            groups.append([1, 9])
            groups.append([5, 2, 10, 12, 15])
            groups.append([6, 3, 11, 13, 16])
            groups.append([7, 4, 14, 17])

        ## Center of mass : 9
        elif CoM == 9:
            groups.append([9])
            groups.append([8, 10, 12, 15])
            groups.append([11, 13, 16, 1])
            groups.append([14, 17, 5, 2])
            groups.append([6, 3])
            groups.append([7, 4])
        ...
        ## Center of Mass : 1
            ...
            groups.append([8, 5, 2])
            groups.append([5, 3, 9])
            groups.append([10, 12, 15, 7, 4])
            groups.append([11, 13, 16])
            groups.append([14, 17])
...
def get_edgeset(dataset='Human36m', CoM=9):
