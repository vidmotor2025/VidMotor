...
class Graph:
    ...
    def __init__(self,
        ...
        if layout.startswith('random_'):
            ...
            assert layout in ['openpose', 'nturgb+d', 'coco', 'coco-wholebody', 'expressive-keypoints','human36m']
    ...
    def get_layout(self, layout):
        if layout == 'openpose':
            ...
            self.center = 0
        elif layout == 'human36m':
            self.num_node = 17
            self.inward = [(1, 0), (4, 0), (2, 1), (5, 4), (3, 2), (6, 5),
                           (7, 0), (8, 7), (9, 8), (10, 9), (11, 8), (14, 8),
                           (12, 11), (13, 12), (15, 14), (16, 15)]
            self.center = 8
