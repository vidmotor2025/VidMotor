...
inward_ori_index = [
    (8, 1), (8, 9), (9, 10), (10, 11),  # head
    (9, 12), (12, 13), (13, 14),  # left arm
    (9, 15), (15, 16), (16, 17),  # right arm
...
num_node_1 = 11
indices_1 = [0, 10, 12, 13, 15, 16, 5, 6, 2, 3, 8]
...
class Graph:
    def __init__(self, labeling_mode='spatial', scale=1):
        ...
        self.A_inward_binary = tools.get_adjacency_matrix(self.inward, self.num_node)
        self.A_neighbor = tools.get_adjacency_matrix(self.neighbor, self.num_node)
        ...
        self.A_A1 = ((self.A_binary + np.eye(num_node)) / np.sum(self.A_binary + np.eye(self.A_binary.shape[0]), axis=1,
                                                                 keepdims=True))[indices_1]
