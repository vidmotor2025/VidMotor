...
def get_parser():
    ...
    parser.add_argument('--step', type=int, default=[160, 250], nargs='+', help='the epoch where optimizer reduce the learning rate')
    parser.add_argument('--lr-decay-rate', type=float, default=0.1, help='decay rate for learning rate')
    parser.add_argument('--warm-up-epoch', type=int, default=20)
    ...
    def start(self):
        ...
        for test_dataset_config in arg.test_feeder_args:
            ...
            train_set = Feeder(test_dataset_config, self.arg.data_centered, self.arg.data_dim,
                               ...
                               data_indices=train_sample_name, stage='train')
