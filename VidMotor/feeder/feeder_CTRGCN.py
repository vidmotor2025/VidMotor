...
class Feeder(Dataset):
    ...
    def __init__(self, dataset_info, data_centered, data_dim, data_norm, score_norm, label_type, data_length=64,
                 data_indices=None, stage=None, require_mask=False):
...
class PretrainFeeder(Feeder):
    def __init__(self, dataset_info, data_centered, data_dim, data_norm, score_norm, label_type, data_length, stage='train'):
        """
        ...
        super().__init__(dataset_info, data_centered, data_dim, data_norm, score_norm, label_type, data_length, stage='train')
