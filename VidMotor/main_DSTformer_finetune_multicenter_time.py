...
def get_parser():
    ...
    parser.add_argument('--lr-backbone', type=float, default=0.00005, help='initial learning rate for backbone model')
    parser.add_argument('--lr-head', type=float, default=0.00005, help='initial learning rate for model')
