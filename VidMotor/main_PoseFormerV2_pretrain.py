...
def get_parser():
    """Define and parse command-line arguments for VidMotor Pretraining (PoseFormerV2)."""
    parser = argparse.ArgumentParser(description='VidMotor Pretraining (PoseFormerV2)')
